...
public class RingBufferTest {
    ...
    public void shouldPublishEventsTwoArgWithBatchSizeOfOne() throws Exception {
        ...
        assertThat(ringBuffer,
                   ringBufferWithEvents(is((Object) "Foo0Bar0-0"), is((Object) "Foo2Bar2-1"), is(nullValue()), is(nullValue())));
    }
    ...
    public void shouldPublishEventsThreeArgBatchSizeOfOne() throws Exception {
        ...
        assertThat(ringBuffer, ringBufferWithEvents(is((Object) "FooBarBaz-0"), is((Object) "FooBarBaz-1"), is(nullValue()),
                                                    is(nullValue())));
    }
    ...
    public void shouldPublishEventsVarArgBatchSizeOfOne() throws Exception {
        ...
        assertThat(ringBuffer, ringBufferWithEvents(is((Object) "FooBarBazBam-0"), is((Object) "FooBarBazBam-1"), is(nullValue()),
                                                    is(nullValue())));
    }
    ...
    public void shouldPublishEventsVarArgWithinBatch() throws Exception {
        ...
        assertThat(ringBuffer,
                   ringBufferWithEvents("Foo1Bar1Baz1Bam1-0", "Foo2Bar2Baz2Bam2-1", "Foo4Bar4Baz4Bam4-2", "Foo5Bar5Baz5Bam5-3"));
    }
    ...
    private Future<List<StubEvent>> getMessages(final long initial, final long toWaitFor) throws InterruptedException,
        ...
        final Future<List<StubEvent>> f = executor.submit(new TestWaiter(cyclicBarrier, sequenceBarrier, ringBuffer, initial,
                                                                         toWaitFor));
